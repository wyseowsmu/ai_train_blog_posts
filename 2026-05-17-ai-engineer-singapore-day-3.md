...
Okay — that's Day 3, and that's the end of the conference. The room ended with Agrim Singh, one of the organisers, telling the story of how this whole thing got vibed into existence in under three months from a lunch conversation in July 2025. Sixty-five labs, a thousand attendees, ninety-one speakers, four parallel tracks, and a closing meditation. The line Vivian used on Day 2 — *"this is all not even their day job. It's a hack, right? But this is the way I believe the future is going to be created."* — was visible in person at the closing.

A real thank-you is in order — to **65 Labs** and the volunteer team for pulling a flagship-scale AI Engineer conference into Singapore inside three months, and to the speakers who flew in from everywhere to teach in 10-to-20-minute increments. And a specific thank-you to **SMU management**, who funded the cohort of us from the AI Team and IITS to be there for all three days. That isn't a small thing. Three days in the room with the people actually building this stuff is hard to replicate from a livestream, and we're genuinely grateful for the opportunity to attend — these recaps are a small part of bringing the value back.

The plan from here is to bring the useful bits back. A few of the talks I didn't cover in this series — Mastra on production agent patterns, the Robot Company on closing the autonomy gap, Hrishi from Southbridge on declarative budgets for legacy systems, the Cursor and Figma design talks, and a chunk of the Physical AI track — are worth their own writeups, and I'll work through them over the coming weeks. Past the writeups, the more interesting work is internal: picking one or two of these patterns (the harness shape, the deterministic-boundary architecture, the Arize-style trace-driven debug loop) and actually trying them on real SMU workflows.

If any of the above resonates in the meantime, the AI Team and IITS are around campus. Come find us. We hope the people who couldn't make it got something useful out of these recaps, and we're looking forward to comparing notes with anyone curious about what to try next.
