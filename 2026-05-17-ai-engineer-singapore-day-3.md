...
A real thank-you is in order — to **65 Labs** and the volunteer team for pulling a flagship-scale AI Engineer conference into Singapore inside three months, to the speakers who flew in from everywhere to teach in 10-to-20-minute increments, and to SMU for hosting Day 1 on campus and underwriting the cohort of us who got to attend. Three days of being in the room with the people actually building this stuff is the kind of thing that's hard to replicate from a livestream, and we don't take that lightly.
